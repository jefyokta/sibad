<div>
    <div class="flex p-20 justify-center w-full">
        <form class="w-full shadow-xl p-10 rounded-xl bg-white border" wire:submit.prevent="save">
            ...
            <div class="mb-5">
                <label for="year" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Tahun Mulai</label>
                <input type="number" id="year" wire:model="year" datepicker-format="yyyy"
                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                    placeholder="YYYY" min="2002" max="2100" required />
