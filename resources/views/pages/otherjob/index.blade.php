                    ...
                    @foreach ($otherjobs as $c)
                        <tr class="odd:bg-white odd:dark:bg-gray-900 even:bg-gray-50 even:dark:bg-gray-800 border-b">
                            ...
                            <td class="px-6 py-4 flex">
                                ...
                                <livewire:delete-button :id="$c->id" model='otherjob' />
                            </td>
                        </tr>
                    @endforeach
                </tbody>
